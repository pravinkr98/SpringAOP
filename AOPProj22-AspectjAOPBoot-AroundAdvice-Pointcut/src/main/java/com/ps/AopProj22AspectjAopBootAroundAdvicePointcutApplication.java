...
public class AopProj22AspectjAopBootAroundAdvicePointcutApplication {
	...
	public static void main(String[] args) {
		...
		ctx=SpringApplication.run(AopProj22AspectjAopBootAroundAdvicePointcutApplication.class, args);
